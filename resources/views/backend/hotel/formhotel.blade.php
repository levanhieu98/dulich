...
<div class="content p-15">
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                <h4 class="page-title"><?php echo __('Add hotel') ?></h4>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card-box">
                <form action="{{route('hotel.store')}}" id="form-create-hotel" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="d-flex">
                    ...
                    <div  class="d-flex">
                        <div class="form-group col-6">
                                <label for="inputState" class="col-form-label"><?php echo __('address') ?></label>
                                <input type="text" class="form-control" value="{{old('address')}}" name="address">
                            </div>
                        <div class="form-group mb-3 col-6">
                            <label for="inputState" class="col-form-label"><?php echo __('Rating') ?></label>
                            <select class="selectpicker "
                            data-style="btn-light" name="rate">
        ...
        height:255px;" /></div>
                    ...
                    <div class="row">
                        <div class="col text-center">
                            <button type="submit" id="btn" class="btn btn-info"><?php echo __('Add hotel') ?></button>
                        </div>
                    </div>
                </form>
            </div>
